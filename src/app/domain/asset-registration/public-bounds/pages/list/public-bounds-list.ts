...
@Component({
  selector: 'app-public-bounds-list',
  imports: [CommonModule, FormsModule, Grid, Breadcrumb],
  templateUrl: './public-bounds-list.html',
  styleUrl: './public-bounds-list.scss',
})
export class PublicBoundsList implements OnInit {
  ...
  gridActions: GridAction[] = [
    { 
      ...
      label: 'Mais opções',
      route: '/asset-registration/public-bounds',
      routeIdKey: 'codigo'
    }
  ];
